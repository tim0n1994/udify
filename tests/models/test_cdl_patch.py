...
class TestGraphDiffer:
    ...
    def test_diff_modify_property(self):
        ...
        old_graph = ContentGraph(media_type=MediaType.GAME)
        old_graph.add_node(
            ContentNode(id="n1", type=NodeType.CHARACTER, name="Hero", properties={"hp": 100})
        )

        new_graph = ContentGraph(media_type=MediaType.GAME)
        new_graph.add_node(
            ContentNode(id="n1", type=NodeType.CHARACTER, name="Hero", properties={"hp": 150})
        )
