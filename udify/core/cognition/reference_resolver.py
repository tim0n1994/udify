...
class ReferenceResolver:
    ...
    def resolve(self, reference_text: str, context: Optional[str] = None) -> Reference:
        """解析参考文本
        ...
        # 4. 返回最佳匹配或空参考
        return best_match or Reference(
            name="unknown",
            type="unknown",
            features=[],
            confidence=0.0
    ...
    def _search_knowledge_base(self, text: str) -> Optional[Reference]:
        """在知识库中搜索匹配"""
    ...
    def _resolve_by_llm(self, reference_text: str, context: Optional[str] = None) -> Optional[Reference]:
        """使用LLM解析参考"""
